...
function echoExecutor(options, context) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, stdout, stderr, success, dataFilePath, doc, compiledJsonFile;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    success = !stderr;
                    try {
                        dataFilePath = path.join(__dirname, '..', '..', '..', 'data', 'pokemon.yaml');
                        doc = yaml.load(fs.readFileSync(dataFilePath, 'utf8'));
                        compiledJsonFile = path.join(__dirname, '..', '..', '..', 'apps', 'website', 'src', 'assets', 'file.json');
